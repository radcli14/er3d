...
let variableDescriptions: [String: String] = [
    ...
    "Longitude": "Lines of constant longitude run from the north to the south pole. Zero longitude is known as the Prime Meridian, and crosses through Greenwich, England, "
]
